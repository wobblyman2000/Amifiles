    ...
    switch (index) {
        ...
        case 6: // Disk Utilities
            html += "<h2>7. Disk Utilities &amp; Premium Tools</h2>"
                    ...
                    "<p><b>How to use:</b></p>"
                    "<ol>"
                    "<li>Select **Edit -> Settings -> Layouts &amp; Rules -> Folder Profiles &amp; Layouts...** (or under Favorites).</li>"
                    ...
                    "<li>**Enforcing Layouts**: Toggle visibility checkboxes to enforce showing/hiding toolbars, the terminal console, favorites sidebars, and custom background colors.</li>"
                    "<li>**Tab Snapshots**: Check **Include Open Tabs Snapshot** and click **Capture Current Open Tabs** to save your active tab lists. Use **Apply Profile to Current View Now** to load them manually on demand.</li>"
                    "<li>**Saving &amp; Auto-Activation**: Click **Save &amp; Apply Profiles**. If **Auto-apply** is checked, the layout, styling, and background color will dynamically activate whenever you browse inside the target path.</li>"
                    "</ol>"

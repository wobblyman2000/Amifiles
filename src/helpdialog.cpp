    ...
    switch (index) {
        ...
        case 1: // Layout & Tabs
            html += "<h2>2. Layout, Splits, &amp; Tabs</h2>"
                    ...
                    "<ul>"
                    "<li><b>Audio Showcase:</b> Designed for music collections with square CD jewel case styling, multi-disc CD grouping (<i>CD1</i>, <i>CD2</i>), tracks drawer, and ID3 metadata integration.</li>"
                    "<li><b>Video Showcase:</b> Tailored for movies and TV shows with 2:3 vertical video poster cards, multi-level series drill-down (<i>Show</i> -&gt; <i>Season</i> -&gt; <i>Episodes</i>), dedicated <b>SEASON 01</b> badges, season artwork scanner, and video resolution badges (4K UHD, 1080p, 720p).</li>"
                    "</ul>"

    ...
    switch (index) {
        ...
        case 1: // Layout & Tabs
            html += "<h2>2. Layout, Splits, &amp; Tabs</h2>"
                    ...
                    "<li><b>TV Series Theme Music Auto-Playback:</b> In <b>Video Showcase</b> mode, navigating into any TV series folder automatically searches for <code>theme.mp3</code> (or <code>theme.ogg</code>/<code>theme.flac</code>) and plays background TV theme music. Moving to another TV show folder seamlessly stops the current theme and plays the new show's theme music. Configurable in <b>Settings -&gt; Preferences</b>.</li>"

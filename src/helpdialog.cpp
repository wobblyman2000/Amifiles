    ...
    switch (index) {
        ...
        case 1: // Layout & Tabs
            html += "<h2>2. Layout, Splits, &amp; Tabs</h2>"
                    ...
                    "<li><b>Version 1.4 Major Milestone Release:</b> Introduces separated Audio Showcase &amp; Video Showcase media views, layout templates &amp; folder profile architecture, Dolphin-style breadcrumb path bar with find-as-you-type folder filters, background TV series theme audio playback, and double-click directory navigation protection.</li>"

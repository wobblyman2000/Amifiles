    ...
    switch (index) {
        ...
        case 1: // Layout & Tabs
            html += "<h2>2. Layout, Splits, &amp; Tabs</h2>"
                    ...
                    "<ul>"
                    "<li><b>Clean Interface (Zen Mode):</b> Right-click and check <i>Clean Interface Mode (Zen Mode)</i> or press <code>F11</code> (or select from the View menu) to hide all toolbars, menus, consoles, and status bars, leaving only the media grid and the preview panel. Right-click or press <code>F11</code> again to toggle back.</li>"
                    "<li><b>Built-in Fullscreen Playback:</b> Right-click and check <i>Double-click Plays Media in Built-in Fullscreen Player</i> to play videos or audio tracks in the built-in media player and go fullscreen automatically on double-click, instead of launching external players.</li>"
                    "</ul>"
                    "</ul>"

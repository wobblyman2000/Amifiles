    ...
    switch (index) {
        ...
        case 1: // Layout & Tabs
            html += "<h2>2. Layout, Splits, &amp; Tabs</h2>"
                    ...
                    "<li><b>Double-click Action Options & Zen Mode Lockdown:</b> Right-click and select whether double-clicking a media card/file starts playing it in the built-in fullscreen player or adds it to the playlist queue instead of interrupting playback. In Zen Mode and Theater View, double-clicking an album folder recursively resolves all tracks (including multi-disc albums) and plays or queues them directly without entering the directory structure as a file list.</li>"

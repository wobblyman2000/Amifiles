    ...
    switch (index) {
        ...
        case 1: // Layout & Tabs
            html += "<h2>2. Layout, Splits, &amp; Tabs</h2>"
                    ...
                    "<li><b>Show Album Tracks Drawer:</b> Toggle this right-click context menu option to show or hide the sliding album tracks list drawer on the right.</li>"
                    "<li><b>Double-click Action Options:</b> Right-click and select whether double-clicking a media card/file starts playing it in the built-in fullscreen player or adds it to the playlist queue instead of interrupting playback.</li>"
                    "<li><b>Auto Full Screen (Auto FS):</b> Toggle the checkable <b>Auto FS</b> button on the media control bar to automatically transition to a borderless full screen playback window after 10 seconds of starting a media item, without requiring any manual hotkey or button triggers.</li>"

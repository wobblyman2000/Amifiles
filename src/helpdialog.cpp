    ...
    switch (index) {
        ...
        case 1: // Layout & Tabs
            html += "<h2>2. Layout, Splits, &amp; Tabs</h2>"
                    ...
                    "<li><b>Music Showcase (Audio Theater):</b> Specialized for music collections and audio albums. Renders square CD Jewel Cases &amp; Vinyl LP sleeves, multi-disc album merging (CD1, CD2, Disc 3), sliding tracklist drawer, batch ID3/FLAC tag editor, and audio visualizer support.</li>"
                    "<li><b>Cinema Showcase (Video Theater):</b> Dedicated to movies, TV series, documentaries, and video hubs. Renders 2:3 widescreen Movie Poster cards with DVD/Blu-Ray case borders, automatic video resolution badges (<i>4K UHD</i>, <i>1080p</i>, <i>720p</i>, <i>CINEMA</i>), auxiliary file hiding (*.nfo, *.srt, cover images), subtitle track selection, and plot synopsis drawers. Supports the following features:</li>"
                    "<ul>"
                    ...
                    "<ul>"
                    "<li><b>Audio Showcase:</b> Designed for music collections with square CD jewel case styling, multi-disc CD grouping (<i>CD1</i>, <i>CD2</i>), tracks drawer, and ID3 metadata integration. Automatically hides loose artwork images and video files for a clean music collection view.</li>"
                    "<li><b>Video Showcase:</b> Tailored for movies and TV shows with 2:3 vertical video poster cards, multi-level series drill-down (<i>Show</i> -&gt; <i>Season</i> -&gt; <i>Episodes</i>), dedicated <b>SEASON 01</b> badges, season artwork scanner, and video resolution badges (4K UHD, 1080p, 720p). Automatically hides loose artwork images, audio files, companion <code>.xml</code>, <code>.nfo</code>, and <code>theme.mp3</code> files for a pristine TV and Movie library view.</li>"
                    "</ul>"

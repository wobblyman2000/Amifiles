    ...
    switch (index) {
        ...
        case 1: // Layout & Tabs
            html += "<h2>2. Layout, Splits, &amp; Tabs</h2>"
                    ...
                    "<p>Select one of the six views from the toolbar dropdown to dynamically re-render directories:</p>"
                    "<ul>"
                    "<li><b>Details Table:</b> Traditional file list. Double-click header columns to auto-fit widths, or drag headers to resize manually. Click column headers (Name, Size, Type, Date) to sort. Integrates EXIF metadata columns (Camera Model, Exposure Time, ISO) that automatically parse and populate for image directories.</li>"
                    ...
                    "<li>Enable the **Rating** and **Comment** columns in the details view header context menu to view these annotations inline.</li>"
                    "</ul>"

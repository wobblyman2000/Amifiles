    ...
    switch (index) {
        ...
        case 1: // Layout & Tabs
            html += "<h2>2. Layout, Splits, &amp; Tabs</h2>"
                    ...
                    "<li><b>Hide Auxiliary / Artwork Files:</b> Automatically filter out non-essential companion files (such as <code>folder.jpg</code>, subtitle files, XML metadata, and movie synopsis NFO files) under the hood inside Cinema Showcase View.</li>"
                    "</ul>"
                     "</ul>"
